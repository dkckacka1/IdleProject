...
namespace IdleProject.Character
{
    ...
    [Serializable]
    public partial class BattleCharacterController : CharacterController
    {
        ...
        public static implicit operator Vector3(BattleCharacterController controller) => controller.transform.position;

        public static implicit operator Transform(BattleCharacterController controller) => controller.transform;
    }
}