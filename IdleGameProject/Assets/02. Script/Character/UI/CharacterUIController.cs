...
namespace IdleProject.Character.UI
{
    public class CharacterUIController : MonoBehaviour
    {
        ...
        private Camera _mainCamera; // 최적화를 위한 캐싱
        ...
        {
            _fluidHealthBar.transform.position = UIManager.GetUIInScreen(_mainCamera.WorldToScreenPoint(_offset.GetFluidHealthBarPosition));
        ...
        public void ShowBattleText(string text)
        {
            ...
            var textPosition = UIManager.GetUIInScreen(_mainCamera.WorldToScreenPoint(_offset.GetHitEffectPosition) + randomPos);
